...
FixGLEPairCheb::FixGLEPairCheb(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
...
void FixGLEPairCheb::initial_integrate(int vflag)
{
  double dtfm;
...
void FixGLEPairCheb::final_integrate()
{
...
double FixGLEPairCheb::compute_vector(int n)
{
  tagint *tag = atom->tag;
...
double FixGLEPairCheb::memory_usage()
{
...
void FixGLEPairCheb::grow_arrays(int nmax)
{
...
------------------------------------------------------------------------- */
void FixGLEPairCheb::read_input()
{
  char line[MAXLINE];
...
------------------------------------------------------------------------- */
void FixGLEPairCheb::update_cholesky() 
{
