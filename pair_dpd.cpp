...
void PairDPD::compute(int eflag, int vflag)
{
  ...
  modify->fix[ifix_force]->end_of_step();
...
void PairDPD::init_style()
{
  ...
  if (ifix_force == -1) {
    ...
    fixarg[0] = (char *) "FORCE_STORE";
    fixarg[1] = (char *) "all";
    fixarg[2] = (char *) "store/state";
    fixarg[3] = (char *) "0";
    fixarg[4] = (char *) "fx";
    fixarg[5] = (char *) "fy";
    fixarg[6] = (char *) "fz";
  ...
  for (int i = 0; i < modify->nfix; i++)
    if (strcmp(modify->fix[i]->style,"store/state") == 0) ifix_force = i;
  if (ifix_force == -1) error->all(FLERR,"store/force does not exist");
}
